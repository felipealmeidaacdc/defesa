 ...
 * @author Aluno
 */
@Form(TipoProduto.class)
public class TipoProdutoView extends BaseView {
     ...
     * @param modal
     */
    public TipoProdutoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    } // fim do método construtor TipoProdutoView
    ...
    private void initComponents() {
        ...
        SwingUtils.setFieldLength(txtTipo, values.Length.TipoProduto.TIPO, SwingUtils.FIXED_LENGTH);
        ...
        consultar.setTitle(bundle.getString("TipoProdutoView.consultar.title")); // NOI18N
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("TextField.shadow")), bundle.getString("TipoProdutoView.jPanel7.border.title"))); // NOI18N

        jLabel17.setText(bundle.getString("filtro")); // NOI18N

        cbFiltro.setModel(new javax.swing.DefaultComboBoxModel<String>(bundle.getString("TipoProdutoView.cbFiltro.array").split(",")));
        ...
        tabelaTipoProduto.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tabelaTipoProdutoMouseReleased(evt);
            }
        });
        tabelaTipoProduto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tabelaTipoProdutoKeyReleased(evt);
            }
        });
        scrollPane.setViewportView(tabelaTipoProduto);
        ...
        setTitle(bundle.getString("TipoProdutoView.title")); // NOI18N
        setResizable(false);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("TextField.shadow")), bundle.getString("TipoProdutoView.jPanel3.border.title"))); // NOI18N

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText(bundle.getString("TipoProdutoView.jLabel1.text")); // NOI18N
    ...
    private void tabelaTipoProdutoMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaTipoProdutoMouseReleased
        if (tabelaTipoProduto.getSelectedRow() != -1) {
            btSelecionar.setEnabled(true);
        }
    }//GEN-LAST:event_tabelaTipoProdutoMouseReleased
    ...
    private void tabelaTipoProdutoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabelaTipoProdutoKeyReleased
        if (tabelaTipoProduto.getSelectedRow() != -1) {
            btSelecionar.setEnabled(true);
        }
    }//GEN-LAST:event_tabelaTipoProdutoKeyReleased
    ...
    protected void callConsulta() throws HeadlessException {
        ...
        try {
            carregarTabela(TipoProduto.class, new TipoProdutoDAO().listar(), 
                    bundle.getString("TipoProdutoView.tabela.vazia"), 
                    scrollPane, tabelaTipoProduto, 
                    bundle.getString("TipoProdutoView.tabela.header"));
            btSelecionar.setEnabled(false);
            consultar.setVisible(true);
        } catch (HibernateException e) {
            JOptionPane.showMessageDialog(getParent(), 
                    bundle.getString("TipoProdutoView.erroCarregar"), 
                    bundle.getString("TipoProdutoView.erroCarregarTitle"), 
    ...
    protected void consultar() {
        try {
            carregarTabela(TipoProduto.class, 
                    new TipoProdutoDAO().consultarPorTipo(txtConsulta.getText()), 
                    bundle.getString("TipoProdutoView.tabela.vazia"), scrollPane, 
                    tabelaTipoProduto, bundle.getString("TipoProdutoView.tabela.header"));
        } catch (HibernateException e) {
    ...
    protected void novo() throws HeadlessException {
        if (!txtTipo.getText().trim().isEmpty()) {
            if (JOptionPane.showConfirmDialog((Frame) getParent(), 
                    bundle.getString("TipoProdutoView.confirmarNovo"), 
    ...
    protected void incluir() {
        if (isFormValid()) {
            ...
            tpTipo = new TipoProdutoDAO().consultarPorTipoUk(txtTipo.getText().trim());
            
            if (tpTipo != null) {
                JOptionPane.showMessageDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.tipoExiste"),
            ...
            try {
                if (JOptionPane.showConfirmDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.confirmarIncluir"), 
                        bundle.getString("incluir"), 0) == 0) {
                    new TipoProdutoDAO().salvar((TipoProduto) entity); // incluir
                    JOptionPane.showMessageDialog((Frame) getParent(), 
                            bundle.getString("TipoProdutoView.incluidoSucesso"));
                    reset(true);
                }
            } catch (HibernateException | HeadlessException e) {
                JOptionPane.showMessageDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.erroIncluir")
                        + "\n<html><b>" + e.getClass() + "</html></b>\n"
                        + bundle.getString("contateDesenvolvedor"), 
                        bundle.getString("TipoProdutoView.erroIncluirTitle"), 
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    protected void alterar() {
        if (isFormValid()) {
            ...
            if (tpTipo != null && !((TipoProduto) entity).getTipo().equals(txtTipo.getText().trim())) {
                JOptionPane.showMessageDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.tipoExiste"),
                        bundle.getString("atencao"), 
                        JOptionPane.WARNING_MESSAGE);
            ...
            try {
                if (JOptionPane.showConfirmDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.confirmarAlterar"), 
                        bundle.getString("alterar"), 0) == 0) {
                    new TipoProdutoDAO().salvar((TipoProduto) entity); // alterar
                    JOptionPane.showMessageDialog((Frame) getParent(), 
                            bundle.getString("TipoProdutoView.alteradoSucesso"));
                    reset(true);
                }
            } catch (HibernateException | HeadlessException e) {
                JOptionPane.showMessageDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.erroAlterar")
                        + "\n<html><b>" + e.getClass() + "</html></b>\n"
                        + bundle.getString("contateDesenvolvedor"), 
                        bundle.getString("TipoProdutoView.erroAlterarTitle"), 
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    protected void excluir() {
        if (!new TipoProdutoDAO().possuiRelacionamento(((TipoProduto) entity).getCdTipoProduto())) {
            try {
                if (JOptionPane.showConfirmDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.confirmarExcluir"), 
                        bundle.getString("excluir"), 0) == 0) {
                    new TipoProdutoDAO().excluir((TipoProduto) entity); // excluir
                    JOptionPane.showMessageDialog((Frame) getParent(), 
                            bundle.getString("TipoProdutoView.excluidoSucesso"));
                    reset(false);
                }
            } catch (HibernateException | HeadlessException e) {
                JOptionPane.showMessageDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.erroExcluir")
                        + "\n<html><b>" + e.getClass() + "</html></b>\n"
                        + bundle.getString("contateDesenvolvedor"), 
                        bundle.getString("TipoProdutoView.erroExcluirTitle"), 
                        JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog((Frame) getParent(), 
                        bundle.getString("TipoProdutoView.tipoEmUso"), 
                        bundle.getString("atencao"), 
                        JOptionPane.WARNING_MESSAGE);
        }
    ...
    protected void selecionar() {
        reset(false);
        entity = ((ObjectTableModel<TipoProduto>) tabelaTipoProduto.getModel()).getValue(tabelaTipoProduto.getSelectedRow());
