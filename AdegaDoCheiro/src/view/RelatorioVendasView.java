...
public class RelatorioVendasView extends javax.swing.JDialog {
     ...
     * @param owner
     * @param modal */
    public RelatorioVendasView(java.awt.Frame owner, boolean modal) {
        super(owner, modal);
        init();
    ...
    public void callEmitirRelatorioVendas() {
        emitirRelatorioVendas.setLocationRelativeTo(null);
        emitirRelatorioVendas.setVisible(true);
    ...
    private void initComponents() {
        ...
        emitirRelatorioVendas = new javax.swing.JDialog();
        ...
        emitirRelatorioVendas.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("res/Bundle"); // NOI18N
        emitirRelatorioVendas.setTitle(bundle.getString("emitirRelatorioVendas.title")); // NOI18N
        emitirRelatorioVendas.setMinimumSize(new java.awt.Dimension(412, 160));
        emitirRelatorioVendas.setModal(true);
        emitirRelatorioVendas.setResizable(false);
        emitirRelatorioVendas.addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowClosed(java.awt.event.WindowEvent evt) {
                emitirRelatorioVendasWindowClosed(evt);
            }
        });

        txt.setEditable(false);
        txt.setText(bundle.getString("RelatorioVendasView.textoEmitir")); // NOI18N
        ...
        javax.swing.GroupLayout emitirRelatorioVendasLayout = new javax.swing.GroupLayout(emitirRelatorioVendas.getContentPane());
        emitirRelatorioVendas.getContentPane().setLayout(emitirRelatorioVendasLayout);
        emitirRelatorioVendasLayout.setHorizontalGroup(
            emitirRelatorioVendasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(emitirRelatorioVendasLayout.createSequentialGroup()
            ...
            .addGroup(emitirRelatorioVendasLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addGroup(emitirRelatorioVendasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(emitirRelatorioVendasLayout.createSequentialGroup()
        ...
        emitirRelatorioVendasLayout.setVerticalGroup(
            emitirRelatorioVendasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(emitirRelatorioVendasLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(txt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
                .addGroup(emitirRelatorioVendasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(emitirRelatorioVendasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addGap(10, 10, 10)
                .addGroup(emitirRelatorioVendasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        setTitle(bundle.getString("RelatorioVendasView.title")); // NOI18N
        ...
        lblTitle.setText(bundle.getString("RelatorioVendasView.title")); // NOI18N
    ...
    private void emitirRelatorioVendasWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_emitirRelatorioVendasWindowClosed
        dispose();
    }//GEN-LAST:event_emitirRelatorioVendasWindowClosed
    ...
    private void emitirRelatorio() {
        new Thread(() -> {
            ...
            ObjectTableModel<VendaItem> tableModel = new ObjectTableModel(VendaItem.class, bundle.getString("RelatorioVendasView.tabela.header"));
            tableModel.setData(new VendaItemDAO().consultarPorPeriodo(ini, fim));
            jTable1.setModel(tableModel);
            
            if (tableModel.getData().isEmpty()) {
                jScrollPane1.setViewportView(new JLabel(bundle.getString("RelatorioVendasView.tabela.vazia"), javax.swing.SwingConstants.CENTER));
    ...
    private void configEventos() {
        ...
        new MyMouseAdapter(btEmitir).setAction(emitirRelatorioVendas, KeyEvent.VK_ENTER, InputEvent.CTRL_DOWN_MASK, () -> {
            emitirRelatorio();
            emitirRelatorioVendas.setVisible(false);
            setVisible(true);
        });
        new MyMouseAdapter(btCancelarEmitir).setAction(emitirRelatorioVendas, KeyEvent.VK_ESCAPE, 0, () -> {
            emitirRelatorioVendas.dispose();
        });
    ...
    private javax.swing.JDialog emitirRelatorioVendas;
...
} // Fim da classe RelatorioVendasView
